...
//        arr.add(1); arr.add(1); arr.add(3); arr.add(2); arr.add(1);
        ...
        for (int i = 0; i < arr.size(); i++) {
            int value = result.get(arr.get(i)) + 1;
...
//            if (result[i] != 0) {
//                int counter = result[i]; int itemIndex = i;
//                while (counter > 0) {
//                    sortedArray[sortedArrayIndex++] = itemIndex;
//                    counter--;
//                }
//            }
//        }
//
//        System.out.println("SortedArray = " + arrayToString(sortedArray));
    ...
    private static String arrayToString(ArrayList<Integer> A ) {
        StringBuilder strBuilder = new StringBuilder();
